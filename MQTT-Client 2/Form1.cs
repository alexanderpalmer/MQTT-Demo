    ...
    public partial class Form1 : Form
    {
        ...
        private void CmdSendMessage_Click(object sender, EventArgs e)
        {
            Task.Run(() =>
            {
                ...
                {
                    mqttClient.Publish("Client2/Message", Encoding.UTF8.GetBytes(TxtInput.Text));
                }
            });
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            Task.Run(() =>
            {
                ...
                mqttClient.Subscribe(new string[] { "Client1/Message" }, new byte[] { MqttMsgBase.QOS_LEVEL_AT_LEAST_ONCE });
                mqttClient.Connect("Client2", "mqttuser", "novonyx");
            });
        }
